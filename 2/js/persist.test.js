...
/** saveToBinary and loadFromBinary */{
    ...
    testEqual('loadFromBinary restore in order', '[{"something":7,"otherThing":42,"thing":1},{"something":3,"otherThing":0,"thing":1}]', async () => {
        initPersist();
        const bitArray = new BitArray(24);
        bitArray.append(0b111101010001011000000001, 24);
    ...
    testEqual('loadFromBinary partial restore if partial data', '[{"something":7,"otherThing":42},{"something":3,"otherThing":0}]', async () => {
        ...
        bitArray.append(0b111101010011000000, 18);
        bitArray.resetOffset();
        const res = [];
...
/** appendArea and extractArea */{
    ...
    testEqual(
        'appendArea store adjusted',
        '10000000 11000000 11000000 10000000 [0:8b] 10000000 [0:8b] 10000000 [0:24b] 11000000 01000000', /* before rotate :
        111 101010 001
        011 000000 001' */
        async () => {
            extraInitPersist();
    ...
    testEqual(
        'appendArea store 8padded',
        '10000000 11000000 11000000 10000000 [0:8b] 10000000 [0:8b] 10000000 [0:24b] 11000000 [0:32b] 01000000', /* before rotate :
        111 101010 001
        011 000000 001' */
        async () => {
            extraInitPersist();
    ...
    testEqual(
        'extractArea restore adjusted',
        '[{"something":7,"otherThing":42,"thing":1},{"something":3,"otherThing":0,"thing":1}]',
        async () => {
            extraInitPersist();
...
/** cumulative import bumpIdsToAvoidMergeCollision */{
    testEqual(
        'bumpIdsToAvoidMergeCollision bump newModel id to avoid active model ids',
        '{"nodes":[{"id":2},{"id":3},{"id":4}],"edges":[{"from":2,"to":3},{"from":4,"to":3}]}',
        async () => {
    ...
    testEqual(
        'bumpIdsToAvoidMergeCollision can use activeModel as reference',
        '{"nodes":[{"id":2},{"id":3},{"id":4}],"edges":[{"from":2,"to":3},{"from":4,"to":3}]}',
        async () => {
